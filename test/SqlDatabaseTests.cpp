...
TEST_F(SqlDatabaseShould, ReturnRowCountWithSelectedRows) {
    SqlDatabase db;
    int insertCount = 7;
    for (int i = 0; i < insertCount; i++) db.insert("NULL, 'Nazwa', '2002-03-16', 21.37");
...
TEST_F(SqlDatabaseShould, ReturnLocalDatabaseWithSelectedMultipleRows) {
    ...
    ASSERT_THAT(localDb->getRows(), UnorderedElementsAre(datatypes::Row{"Nazwa1", "2002-03-16", 21.37},
...
TEST_F(SqlDatabaseShould, InsertRowWithRowObject) {
    SqlDatabase db;
    std::vector<datatypes::Row> rows{{"N1", "2000-01-01", 4.99}, {"N2", "2000-01-01", 5.99}};
